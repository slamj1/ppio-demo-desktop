...
export const DL_TASK = {
  ...
  ACT_RECOVER_TASK: 'action_recoverDownloadTask',
  MUT_RECOVER_TASK: 'mutation_recoverDownloadTask',
...
export const UL_TASK = {
  ...
  ACT_RECOVER_TASK: 'action_recoverUploadTask',
  MUT_RECOVER_TASK: 'mutation_recoverUploadTask',
