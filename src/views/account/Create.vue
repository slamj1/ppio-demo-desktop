  ...
  <div class="account">
    ...
    <div class="form-wrap">
      ...
      <template v-else>
        ...
        <el-input type="textarea" :autofocus="true" :rows="4" resize="none" placeholder="enter your Encryption Key" v-model="repeatMnemonic" class="seed-phrase-input"> </el-input>
...
export default {
  ...
  methods: {
    ...
    f_confirm() {
      if (this.repeatMnemonic === this.mnemonic) {
        this.confirmLoading = true
        this.$store
          .dispatch(ACT_LOGIN, this.mnemonic)
          .then(account => {
