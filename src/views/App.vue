  ...
  <div id="app" @dragover="f_onDragover">
    ...
    >
      <el-input
        ...
        type="password"
        v-model="passphrase"
        @keyup.native.enter="f_startAppWithPassphrase"
      ></el-input>
      <el-alert
        class="passphrase-alert"
        v-show="passphraseErrMsg.length > 0"
        type="error"
        :closable="false"
        >{{ passphraseErrMsg }}</el-alert
      >
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          type="primary"
          @click="f_startAppWithPassphrase"
